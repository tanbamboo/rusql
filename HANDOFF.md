...
| Branch | issue-265-m114-create-database-charset |
| Next step | **M115 JSON_EXTRACT** (#266). Label `agent-ready` after M114 merge. Phase R issues #265–#283 filed. Ultimate MySQL 8.0 goal is **not** complete. |
...
| Phase R (M114–M132) | **M114 in this PR** — GitHub milestone [Phase R](https://github.com/tanbamboo/rusql/milestone/9); next `agent-ready` [#266 M115](https://github.com/tanbamboo/rusql/issues/266) |
