...
| Branch | main |
| Next step | Implement [M80 SHOW VARIABLES](https://github.com/tanbamboo/rusql/issues/193) |
...
1. `SHOW VARIABLES` catalog over the documented @@ stub set — [M80 #193](https://github.com/tanbamboo/rusql/issues/193)
