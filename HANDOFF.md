...
| Branch | main |
| Next step | **M115 JSON_EXTRACT** (#266) — M114 is on `main` (PR #346). Label #266 `agent-ready`. Phases S–Z filed (#285–#363, milestones 10–17) but not `agent-ready`. Ultimate MySQL 8.0 goal is **not** complete. |
...
| Phase R (M114–M132) | **M114 merged** (PR #346 / #265). Next: [#266 M115](https://github.com/tanbamboo/rusql/issues/266) |
