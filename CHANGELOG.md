...
- **Docs** — Phases S–Z (M133–M210) filed: GitHub milestones [S](https://github.com/tanbamboo/rusql/milestone/10)–[Z](https://github.com/tanbamboo/rusql/milestone/17), issues #285–#363 (GitHub #346 is the in-flight M114 PR). Recreate with `node scripts/create-phase-s-z-issues.mjs`. None labeled `agent-ready` (wait for M114 and prior-phase deps). Ultimate MySQL 8.0 goal remains unmet.
